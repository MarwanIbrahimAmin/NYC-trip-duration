...
if __name__ == '__main__':
    ...
    model_params = config['Model']['LightGBM'].copy()
    ...
    importances = trainer.reg.feature_importances_
    ...
    model_save_path = os.path.join(config['save_paths']['models_dir'], "lightgbm_model.joblib")
